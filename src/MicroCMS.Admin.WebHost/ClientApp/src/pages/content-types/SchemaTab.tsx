...
<div className="space-y-3">
 ...
 <div
  ...
  className={`rounded-lg border p-4 ${
      activeFieldIdx === idx ? 'border-brand-300 bg-brand-50/40' : 'border-slate-200'
              }`}
         >
       {/* Field summary row */}
        <div
   ...
   >
    ...
    {watch(`fields.${idx}.name`) || (
      ...
      className={`rounded px-1.5 py-0.5 text-xs font-medium ${
            FIELD_TYPE_COLORS[watch(`fields.${idx}.type`)] ?? 'bg-slate-100 text-slate-600'
     }`}
         >
