...
namespace MicroCMS.Infrastructure.Migrations
{
    ...
    [Migration("20260508074915_AddContentTypeParent")]
    partial class AddContentTypeParent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MicroCMS.Domain.Aggregates.Components.Layout", b =>
                {
                    ...
                    b.Property<bool>("IsShellCustomized")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("MicroCMS.Domain.Aggregates.Content.ContentType", b =>
                {
                    ...
                    b.Property<Guid?>("ParentContentTypeId")
                        .HasColumnType("TEXT")
                    ...
                    b.HasIndex("ParentContentTypeId");
            ...
            modelBuilder.Entity("MicroCMS.Domain.Aggregates.Content.EntryGroup", b =>
                {
                    ...
                    b.HasIndex("SiteId", "ContentTypeId", "Handle")
                        .IsUnique();

                    b.ToTable("EntryGroups", (string)null);
                });
            ...
            modelBuilder.Entity("MicroCMS.Infrastructure.Storage.Database.MediaBlobRecord", b =>
                {
                    b.Property<string>("StorageKey")
                        .HasMaxLength(1024)
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("MicroCMS.Domain.Aggregates.Content.ContentType", b =>
                {
                    b.HasOne("MicroCMS.Domain.Aggregates.Content.ContentType", null)
                        .WithMany()
                    ...
                    b.OwnsMany("MicroCMS.Domain.Aggregates.Content.EntryGroupMember", "Members", b1 =>
                        {
                            ...
                            b1.HasKey("GroupId", "EntryId");

                            b1.ToTable("EntryGroupMembers", (string)null);
